...
public class GooglePlacesAutocompleteAdapter extends ArrayAdapter implements Filterable {
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    resultList = autocomplete(constraint.toString(), context);
                    if (resultList != null) {
    ...
    private static ArrayList autocomplete(String input, Context context) {
        ...
        try {
            ...
            // Replace it with your google map api key.
            String API_KEY = context.getString(R.string.google_map_api);
